...
incbin "../data/cutscenes/Tiles_Title_Background_Mode7.bin" ; $10D7 bytes
...
incbin "../data/cutscenes/Tiles_Title_Sprite.bin" ; $2509 bytes
...
incbin "../data/cutscenes/Tiles_Baby_Metroid_Mode7.bin" ; $24E bytes
...
incbin "../data/cutscenes/Tiles_Gunship_Ceres_Mode7.bin" ; $285A bytes


;;; $95:D089: Tiles - font 1 ;;;
Tiles_Font1_BG3:
; Decompressed to $7F:8000..88FF around $8B:A410, then transferred to VRAM $4000..447F (BG3 tiles)
incbin "../data/cutscenes/Tiles_Font1_BG3.bin" ; $68A bytes
...
incbin "../data/cutscenes/Gunship_Ceres_Tilemap.bin" ; $AB bytes
...
incbin "../data/cutscenes/Intro_BG1_MotherBrainsRoom_Tilemap.bin" ; $9B7 bytes
...
incbin "../data/cutscenes/Intro_BG2_SamusHead_Tilemap.bin" ; $20F bytes


;;; $97:8ADB: Tilemap - Zebes ;;;
Zebes_Tilemap:
; Decompressed to $7F:9000..97FF around $8B:C6BE, then transferred to VRAM $5C00..5FFF (BG1 tilemap)
incbin "../data/cutscenes/Zebes_Tilemap.bin" ; $237 bytes
...
incbin "../data/cutscenes/Intro_BG3_TheLastMetroidIsInCaptivity_Tilemap.bin" ; $E2 bytes
...
incbin "../data/cutscenes/GameOptionsMenu_OptionsScreen_Tilemap.bin" ; $1D9 bytes
...
incbin "../data/cutscenes/GameOptionsMenu_ControllerSettings_English_Tilemap.bin" ; $1F7 bytes
...
incbin "../data/cutscenes/GameOptionsMenu_ControllerSettings_Japanese_Tilemap.bin" ; $1C9 bytes
...
incbin "../data/cutscenes/GameOptionsMenu_SpecialSettings_English_Tilemap.bin" ; $1AD bytes
...
incbin "../data/cutscenes/GameOptionsMenu_SpecialSettings_Japanese_Tilemap.bin" ; $1BA bytes
...
incbin "../data/cutscenes/Samus_Waiting_for_Credits_to_End_Tilemap.bin" ; $10F bytes
...
incbin "../data/cutscenes/Tiles_Samus_Waiting_for_Credits_to_End.bin" ; $2154 bytes
...
incbin "../data/cutscenes/Tiles_PostCredits_SuitlessSamus.bin" ; $1EA5 bytes
...
incbin "../data/cutscenes/Tiles_PostCredits_Samus_Shooting_the_Screen.bin" ; $FE2 bytes
...
incbin "../data/cutscenes/Tiles_Font3_Background.bin" ; $721 bytes
...
incbin "../data/cutscenes/Credits_Tilemap.bin" ; $A88 bytes
...
incbin "../data/cutscenes/InterleavedTilesTilemapPostCreditsSamusBeamMode7.bin" ; $97C bytes
...
incbin "../data/cutscenes/Tiles_Zebes_Explosion.bin" ; $32BD bytes
...
incbin "../data/cutscenes/Wide_Part_of_Zebes_Explosion_Tilemap.bin" ; $296 bytes
...
incbin "../data/cutscenes/Concentric_Wide_Part_of_Zebes_Explosion_Tilemap.bin" ; $296 bytes
...
incbin "../data/cutscenes/Eclipse_of_Zebes_during_Explosion_Tilemap.bin" ; $1E0 bytes


;;; $98:BCCD: Tilemap - blank ;;;
Blank_BG2_Tilemap:
; Decompressed to $7F:F800..FFFF around $8B:D5F3, then transferred to VRAM $7C00..7FFF (BG2 tilemap)
incbin "../data/cutscenes/Blank_BG2_Tilemap.bin" ; $9 bytes
...
incbin "../data/cutscenes/Tiles_Zebes_Being_Zoomed_Out_during_Zebes_Explosion_Mode7.bin" ; $3079 bytes
...
incbin "../data/cutscenes/Tiles_Grey_Clouds_during_Zebes_Explosion_Mode7.bin" ; $23B1 bytes
...
incbin "../data/cutscenes/Tiles_Big_Zebes_during_Zebes_Explosion.bin" ; $146E bytes
...
incbin "../data/cutscenes/Tiles_Yellow_Clouds_during_Zebes_Explosion.bin" ; $2C0F bytes
...
incbin "../data/cutscenes/InterleavedTilesTilemap_ZebesBeingZoomedOutExplosion_Mode7.bin" ; $4DD bytes
...
; The tiles bytes are zero/ignored >_<;
incbin "../data/cutscenes/InterleavedTilesTilemap_GreyCloudsDuringZebesExplosion_Mode7.bin" ; $2D7 bytes
...
; The tiles bytes are zero/ignored >_<;
incbin "../data/cutscenes/InterleavedTilesTilemap_BigZebesDuringZebesExplosion_Mode7.bin" ; $16D bytes
...
incbin "../data/cutscenes/Tiles_PostCredits_Samus_Transformation_Effect.bin" ; $12 bytes
...
incbin "../data/cutscenes/PostCredits_Samus_Transformation_Effect_Tilemap.bin" ; $5D8 bytes
...
incbin "../data/cutscenes/Tiles_PostCredits_SuperMetroid_Icon.bin" ; $C3B bytes
...
incbin "../data/cutscenes/PostCredits_SuperMetroid_Icon_Tilemap.bin" ; $15D bytes
